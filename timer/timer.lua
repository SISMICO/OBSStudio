...
function script_properties()
	...
	obs.obs_properties_add_int(props, "startedTimer", "Started At (seconds)", 0, 100000, 1)
...
function script_description()
	return "Sets a text source to act as a timer when the source is active.\n\nMade by Bento based on Countdown by Jim"
end
...
function script_update(settings)
	...
	startedSeconds = obs.obs_data_get_int(settings, "startedTimer")
...
function script_defaults(settings)
	obs.obs_data_set_default_int(settings, "startedTimer", 0)
end
